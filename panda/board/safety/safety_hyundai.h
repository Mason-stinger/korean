...
const int HYUNDAI_MAX_RT_DELTA = 200;          // 테네시 수정 max delta torque allowed for real time checks
const uint32_t HYUNDAI_RT_INTERVAL = 250000;   // 250ms between real time checks
const int HYUNDAI_MAX_RATE_UP = 5; // 테네시 수정
const int HYUNDAI_MAX_RATE_DOWN = 10; // 테네시 수정
